    ...
    <div className='h-[calc(100vh-120px)] border flex justify-center items-center'>
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <form action="" onSubmit={handleSubmit(onSubmit)}>
                <div className='mb-4'>
                    <label className='block text-gray-7000 text-sm font-bold mb-2' htmlFor="email">Email</label>
                    <input 
                ...
                <div className='mb-4'>
                    <label className='block text-gray-7000 text-sm font-bold mb-2' htmlFor="password">Password</label>
                    <input
