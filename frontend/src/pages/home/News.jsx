...
const News = () => {
  return (
    <div className='py-16'>
      <h2 className='test-3xl font-semibold mb-6'>News </h2>
      <Swiper
            slidesPerView={1}
            spaceBetween={30}
            navigation={true}
              ...
              news.map((item, index) => (
                <SwiperSlide key={index}>
                  <div className='flex flex-col sm:flex-row sm:justify-between items-center gap-12'>
                    ...
                    <div className='py-4'>
                      <Link to="/">
                          <h3 className="test-lg font-medium hover:text-blue-500 mb-4">{item.title}</h3>
                      </Link>
                      <div className='w-32 h-[4px] bg-primary mb-5'></div>
